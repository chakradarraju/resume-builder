...
const EditableText: React.FC<{placeholder?: string, className?: string, value?: string, multiline?: boolean, onChange?: ChangeEventHandler}> = ({placeholder, className, value, multiline, onChange}) => {
